...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*
		 * teste de POO fazendo uma classe para calcular a área de 2 triângulos e
		...
		if (result1 > result2) {
			System.out.printf("triangulo 1 %.2f é maior: ", result1);

		} else {
			System.out.printf("triangulo 2 %.2f é maior", result2);
		}
